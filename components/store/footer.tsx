...
export default function StoreFooter({ handleNavigate }: StoreFooterProps) {
    ...
    <footer className="bg-white border-t py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold text-green-700 mb-4">IBNI Store</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <button onClick={() => navigate("backpack-builder")} className="text-gray-600 hover:text-green-600">
                  Build a Backpack
                </button>
              </li>
              <li>
                <button onClick={() => navigate("store-bulk-purchase")} className="text-gray-600 hover:text-green-600">
                  Bulk Purchase
                </button>
              </li>
              <li>
                <button onClick={() => navigate("store-special-offers")} className="text-gray-600 hover:text-green-600">
                  Special Offers
                </button>
              </li>
            </ul>
