...
export default function TeacherProfileBouaziz({ navigateTo, userType = "parent", showBackButton = true }: TeacherProfileBouazizProps) {
  ...
  // Mock teacher data for Nadia Bouaziz
  const teacher = {
    id: "teacher5",
    name: "Nadia Bouaziz",
    ...
    students: 280,
    courses: 6,
    hourlyRate: "2,800 DZD",
    availability: "Weekdays 2PM-8PM, Saturdays 10AM-4PM",
    ...
    specialties: ["Web Development", "UI/UX Design", "Digital Illustration", "Animation", "Game Design Basics"],
    about:
      "Nadia Bouaziz is a dynamic freelance instructor specializing in the intersection of technology and art. With 7 years of teaching experience, she has established herself as a leading educator in Computer Science and Digital Arts in the Tlemcen region. After working at École Polytechnique Préparatoire, she chose to pursue independent teaching to develop innovative curricula that bridge technical skills with creative expression. Her courses combine rigorous programming fundamentals with artistic applications, preparing students for careers in tech, design, and digital media.",
    teachingApproach:
      "My teaching philosophy centers on project-based learning where students create real-world applications while mastering technical concepts. I believe in a balanced approach that develops both analytical thinking and creative problem-solving. My courses are highly interactive, with live coding sessions, design critiques, and collaborative projects. I adapt my teaching to accommodate different learning paces and backgrounds, providing additional resources for beginners while challenging advanced students with complex projects. As a freelance instructor, I continuously update my curriculum to reflect industry trends and emerging technologies.",
    isIndependent: true,
  }
  ...
  const reviews = [
    {
      ...
      date: "May 10, 2025",
      comment:
        "Professor Bouaziz's web development course transformed my career path. Her teaching style makes complex programming concepts accessible, and the projects we completed are now the highlights of my portfolio. She goes above and beyond to support her students even after the course ends.",
      helpfulCount: 15,
    },
    {
      id: 2,
      name: "Karim Zidane",
      avatar: "/placeholder.svg?height=40&width=40&text=KZ",
      rating: 5,
      date: "April 22, 2025",
      comment:
        "The Digital Illustration course was exactly what I needed to transition from traditional to digital art. Nadia's feedback is always constructive and specific, helping me improve rapidly. The small class size ensures personalized attention for each student.",
      helpfulCount: 12,
    },
    {
      id: 3,
      ...
      date: "March 15, 2025",
      comment:
        "I took the UI/UX Design course as a complete beginner, and now I'm working on my first professional project. Nadia creates a supportive learning environment where questions are encouraged. The course materials are comprehensive and up-to-date with industry standards.",
      helpfulCount: 9,
    },
  ]
  ...
  const courses = [
    {
      ...
      image: "/placeholder.svg?height=160&width=320&text=Web+Development",
      duration: "12 weeks",
      students: 48,
      rating: 4.9,
      reviewCount: 32,
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=160&width=320&text=UI/UX+Design",
      duration: "8 weeks",
      students: 36,
      rating: 4.8,
      reviewCount: 24,
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=160&width=320&text=Digital+Art",
      duration: "10 weeks",
      students: 30,
      rating: 4.7,
      reviewCount: 18,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="relative w-full h-64 rounded-xl overflow-hidden mb-8">
        <Image
          src="/placeholder.svg?height=400&width=1200&text=Creative+Technology+Education"
          alt="Nadia Bouaziz - Creative Technology Educator"
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-8">
        <div className="flex-shrink-0 -mt-24 ml-6 z-10 relative">
          <div className="w-36 h-36 rounded-full overflow-hidden border-4 border-white bg-white shadow-lg">
            <Image
              src="/placeholder.svg?height=144&width=144&text=NB"
                  ...
                  <div className="space-y-3">
                    {teacher.languages.map((language, index) => (
                      <div key={index} className="flex items-center justify-between">
                        <span>{language}</span>
                        <Progress value={index === 0 ? 100 : index === 1 ? 95 : 90} className="h-2 w-24" />
                      </div>
                    ))}
                  </div>
                </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span>nadia.bouaziz@creativetech.dz</span>
                </div>
                <div className="flex items-center">
